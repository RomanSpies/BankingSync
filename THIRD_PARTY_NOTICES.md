...
bankingsync uses the following third-party libraries. Their licenses are reproduced below or referenced by type.
...
| github.com/grafana/pyroscope-go/godeltaprof | v0.1.9 | Apache-2.0 |
| github.com/grpc-ecosystem/grpc-gateway/v2 | v2.28.0 | BSD-3-Clause |
| github.com/hashicorp/golang-lru/v2 | v2.0.7 | MPL-2.0 |
| github.com/klauspost/compress | v1.17.8 | BSD-3-Clause |
...
| google.golang.org/genproto/googleapis/api | v0.0.0-20260209 | Apache-2.0 |
| google.golang.org/genproto/googleapis/rpc | v0.0.0-20260209 | Apache-2.0 |
| google.golang.org/grpc | v1.79.2 | Apache-2.0 |
| modernc.org/gc/v3 | v3.0.0-20240107 | BSD-3-Clause |
| modernc.org/libc | v1.49.3 | BSD-3-Clause |
...
Full license texts for each dependency can be found in their respective source repositories or in the Go module cache under `$GOMODCACHE`.
